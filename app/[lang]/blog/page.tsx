...
import {
  getPostsPaginated,
  getAllCategoriesWithLanguage,
  getAllTagsWithLanguage,
  getAllAuthors,
  getBlogPageContent,
} from "@/lib/wordpress";
...
export async function generateMetadata({
  ...
  try {
    ...
    const blogPage = await getBlogPageContent(language);
  ...
  try {
    const [
      ...
      getPostsPaginated(page, postsPerPage, {
        author: searchParamsData.author,
        category: searchParamsData.category,
        tag: searchParamsData.tag,
        search: searchParamsData.search,
      }),
      getAllCategoriesWithLanguage(language),
      getAllTagsWithLanguage(language),
      getAllAuthors(),
      getBlogPageContent(language),
    ]);
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-sm text-muted-foreground">
                <Balancer>
                  ...
                  {searchParamsData.search && ` for "${searchParamsData.search}"`}
                </Balancer>
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <Suspense fallback={<div>Loading search...</div>}>
                <SearchInput defaultValue={searchParamsData.search} />
              </Suspense>
              <Suspense fallback={<div>Loading filters...</div>}>
                <FilterPosts
                  ...
                  selectedAuthor={searchParamsData.author}
                  selectedTag={searchParamsData.tag}
                  selectedCategory={searchParamsData.category}
                />
              </Suspense>
            </div>
            ...
            {totalPages > 1 && (
              <div className="flex justify-center gap-2 items-center">
                {page > 1 && (
                  <a
                    href={`/${lang}/blog?page=${page - 1}${buildQueryString(searchParamsData, { page: undefined })}`}
